...
이 스크립트는 알파제로 알고리즘을 사용하여 오셀로 AI를 학습시킵니다.
"""
...
from model.Othello.alphazero import AlphaZero
...
def main():
    ...
    parser = argparse.ArgumentParser(description='알파제로 오셀로 학습')
