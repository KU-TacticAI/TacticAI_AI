...
이 스크립트는 알파제로 알고리즘을 사용하여 체스 AI를 학습시킵니다.
"""
...
from model.Chess.alphazero import AlphaZero
...
def main():
    ...
    parser = argparse.ArgumentParser(description='알파제로 체스 학습')
